...
Public Class Class2
    ...
    Public Sub Grabar(ByVal mensage As String)
        ...
        Try
            ...
            objWriter.Write("#")
            objWriter.Close()
            'Dim arrayParametros() As String = {"cd C:\Users\ibaid\Documents\GitHub\Meteo_AD", "git add .", "git commit -m NewUpdate", "git push origin"}
            'metodoGit(arrayParametros)
    ...
    'Private Sub metodoGit(ByVal array() As String)
    'Dim comando As String = "/c "
    'For i As Integer = 0 To UBound(array)
    '       comando += (array(i) + " & ")
    'Next'
    '
    'Dim psi As New ProcessStartInfo("cmd.exe", comando)
    '   psi.WindowStyle = ProcessWindowStyle.Hidden

    '  Process.Start(psi)

    ' MsgBox("Git actualizado")
